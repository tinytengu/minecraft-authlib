...
public class YggdrasilUserAuthentication extends HttpUserAuthentication {
    ...
    protected void logInWithPassword() throws AuthenticationException {
        ...
        AuthenticationResponse response = getAuthenticationService().<AuthenticationResponse>makeRequest(this.routeAuthenticate, request, AuthenticationResponse.class);
    ...
    protected void logInWithToken() throws AuthenticationException {
        ...
        RefreshResponse response = getAuthenticationService().<RefreshResponse>makeRequest(this.routeRefresh, request, RefreshResponse.class);
        if (!response.getClientToken().equals(getAuthenticationService().getClientToken())) {
            throw new AuthenticationException("Server requested we change our client token. Don't know how to handle this!");
        }
        if (response.getSelectedProfile() != null) {
